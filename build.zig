...
pub fn build(b: *std.Build) void {
    ...
    // Link X11 libraries for X11 support
    ...
    // Link libc for environment variables
    exe.root_module.linkSystemLibrary("c", .{});

    // This declares intent for the executable to be installed into the
    // standard location when user invokes the "install" step (the default
    // step for running `zig build`).
